...
% Durant mon stage j'ai également faire une proposition pour mettre en place différents outils permettant un maintient des performances des différents services Dynamease. Pour faire cette proposition j'ai d'abord lister les différents besoin :
