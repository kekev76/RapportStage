...
Afin de régler ce type de problème, un caractère spécial '\' est ajouté devant chaque caractère spécial pouvant être trouvé dans le nom ou les informations clients. Ce caractère à pour fonction, dans l'Objective-C de signifier à l'application de ne pas interpréter le caractère spécial qui le suit. 

\subsection{Rétrocompatibilité Ios}
\subsection{Recherche des contacts}
\subsection{Récupération automatique des contacts}